...
const String kPM = 'pm';
const String kCM = ' cm';
const String kMon = 'Mon';
const String kTue = 'Tue';
const String kWed = 'Wed';
const String kThur = 'Thur';
const String kFri = 'Fri';
const String kSat = 'Sat';
const String kSun = 'Sun';
...
const String kPleaseEnterAValid = '* Please Enter a Valid ';
const String kPleaseChoose = '* Please Choose ';
const String kPasswordMismatch = '* Password Mismatch';

/// Connection
const String kConnectionError =
    'Your phone doesn\'t have an Internet connection,\nplease check connection and ';
const String kTryAgain = 'try again';
const String kServerError = '$kAppTitle server unreachable.\nPlease ';
const String kVersionError =
    'App upgrade is required,\nplease upgrade to the latest version\nand ';

/// Onboarding
const String kSkip = 'Skip';
const String kNext = 'Next';
const List<String> kOnBoardingMessage = [
...
/// Login and Register
const String kYouCanAlsoLoginWith = 'You can also login with …';
const String kNotRegisteredYet = 'Not registered yet? ';
const String kSignUpExclamation = 'Sign up!';
const String kAlreadyRegistered = 'Already registered? ';
